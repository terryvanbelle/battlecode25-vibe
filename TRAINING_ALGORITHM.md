...
Each entry is a rule, its decisive numbers, and where it applies. The narrative
that earned a rule — who hit it, on which run, and what it cost — lives in
`TRAINING_CASES.md`, pointed at from the entries that have one. That split was
made because this file is read in full at every cold start by every lineage, and
the stories are what you want when a rule surprises you rather than what you need
in front of you to follow it. Nothing was deleted and no rule moved.
...
1. **Determinism means re-running is worthless — but it does NOT mean your
   ...
   (more maps, more opponents).
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 1.
...
12. **Track a fixed old-bot roster for long-run progress.** Peer retirement
   ...
   one.
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 12.
...
14. **Check that two agreeing numbers are actually two numbers.** Rule 13 says a
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 14.
...
15. **Before you build an instrument, check its statistic can separate the
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 15.
...
16. **Check your evaluation covers the REGIME where you actually lose.** The
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 16.
...
17. **A self-play instrument is blind to any deficit your opponent shares.**
    ...
    *itself* — a different build, but the same assumptions. So a weakness both
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 17.
...
18. **Replay per-robot state is recorded POST-action. Never use it to estimate
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 18.
...
19. **A lesson you wrote is not a control. Install the check where the mistake
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 19.
...
20. **A pooled tournament rate is a statement about a THREE-body system, never
    ...
    → evidence and case study: `TRAINING_CASES.md`, doctrine 20.
