...
public class RobotPlayer {
    ...
    static boolean walkHomeIfDry(int cap) throws GameActionException {
        ...
        homeTurns++;
        // ---- ITERATION 73: the refill path had NO fallback (a defect of mine) --------------
        // walkHomeIfDry has shipped since iteration 60 calling stepToward and nothing else.
        // stepToward tries only 5 of 8 directions (direct, +-1, +-2); moveExploring at least
        // follows a failure with 4 random attempts, and this path does not.
        // Measured from per-round robot TRACKs on Mirage: splashers WITH paint available are
        // stationary on 9.2-23.5% of turns, and at those moments they have a mean of only
        // 1.2-1.6 adjacent WALLS out of 8, with 27-50% having NO adjacent wall at all. They are
        // blocked by ROBOTS, transiently, with free directions this path never tries. All three
        // tracked splashers ended at paint=0.
