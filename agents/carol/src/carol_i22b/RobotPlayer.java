...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "i22b";
     ...
     */
    // Iteration 22: SPLASHER share as a dose, with a zero arm -- never swept in 22 iterations.
    // The mopper sweep taught that unit PRICE on the binding axis matters more than throughput:
    // a splasher costs 300 paint against a soldier's 200 and a mopper's 100, drawn from a tower
    // stash that is under 200 on 57-99% of tower turns. So the 2.6x tiles/turn advantage may be
    // unaffordable in exactly the games carol loses. Incumbent is 3; this arm is 6.
    static final int SPLASHER_IN_20 = 6;
