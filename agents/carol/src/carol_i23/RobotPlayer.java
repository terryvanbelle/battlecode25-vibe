...
public class RobotPlayer {
    ...
    // Iteration 23: bracket the mopper peak from BELOW. Measured so far: dose 0 = 35% (bad),
    // dose 2 = accepted at 65% over dose 5, dose 5 = the old incumbent. So the optimum lies in
    // {1, 2} unless the curve is flat there, and dose 1 is the only untested point between a
    // known-bad arm and the current best. One constant.
    static final int MOPPER_IN_20 = 1;
