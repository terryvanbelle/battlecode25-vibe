...
public class RobotPlayer {
    ...
    // Iteration 20. TOWER_DRY = a soldier's 200 paint: below this a tower cannot build the
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " fl=" + ferryLoad + " fd=" + ferryDrop + " fs=" + ferrySeek + " | " + state);
        Clock.yield();
    }
    ...
    static String runMopper() throws GameActionException {
        ...
        // OWN stash [E: RULES.md item 4], and across 8 complete iteration-14 games that stash
        // is below a soldier's 200 on 99.1% of tower turns on Parking_lot and 97.3% on
        // gridworld -- the same maps banking a median 76,420 idle chips. RULES.md: "a money
        // tower ... goes dry until a mopper refills it", and only moppers transfer paint
        // robot->robot. Carol's single transferPaint call is a WITHDRAWAL: her moppers have
        // never given paint to anything, while idling on 95.1% of 78,480 turns. An idle mopper
        // is a 100-paint truck that is already built and paid for.
        //
        // Delivery stops at half capacity on purpose: refillIfPossible() returns early once
        // paint*2 >= cap, so a mopper that has just delivered will NOT turn around and withdraw
        // its own cargo back out of the tower it just filled.
