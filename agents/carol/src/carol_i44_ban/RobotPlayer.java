...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "i44ban";
    ...
    static void workOnRuin(MapLocation ruin) throws GameActionException {
        ...
        // ABLATION ARM (i44ban): the denial ban is REMOVED; only the 8-slot ban set remains,
        // fed exclusively by the old 40-turn patience timeout. Counters still report so the
        // arm's inertness is visible rather than assumed.
        if (enemyBlock > 0 && marked > 0) {
            denyBans++;   // counted, NOT acted on
        }
    }
