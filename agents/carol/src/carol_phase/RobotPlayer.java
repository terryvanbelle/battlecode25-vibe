...
public class RobotPlayer {
    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        rng = new Random(rc.getID() * 7919 + 14);   // PHASE-ONLY CHANGE (iteration 43 calibration).
        // Policy-identical to carol_iter36 in every respect; only the PRNG stream differs. Two
        // arms like this bound the noise floor of a 150-game full-corpus census, which is NOT
        // zero: the census removes map SAMPLING error, but the residue is engine chaos, and a
        // code change perturbs the stream. Measuring my own floor rather than inheriting
        // another lineage's 4.80, because carol's chaos need not match theirs.
