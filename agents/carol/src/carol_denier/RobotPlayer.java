package carol_denier;

/* SYNTHETIC ARCHETYPE -- "the denier". FROZEN: never edit this file.
 *
...
public class RobotPlayer {
    ...
    static String runMopper() throws GameActionException {
        ...
        MapLocation hunt = nearestVisibleEnemyPaint();
        moveExploring(hunt);
        return state + (hunt != null ? " hunt" : "") + " dn=" + denied;
    }
    ...
    static String runSplasher() throws GameActionException {
        ...
        return "P" + tag + (hunt != null ? " hunt" : "") + " s=" + bestScore
