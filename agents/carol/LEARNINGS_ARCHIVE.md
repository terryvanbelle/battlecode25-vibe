# Carol — LEARNINGS ARCHIVE (BC25)

**This file is GREP-ONLY. Never read it whole.** It is the complete, unabridged record; the
live digest is `LEARNINGS.md`, which points here by heading. Nothing is ever deleted from this
file — entries are superseded in place, per the logging doctrine. Search it by heading text or by
the keyword of the lesson you are checking, e.g. `grep -n -A20 "Cost the price" LEARNINGS_ARCHIVE.md`.
