...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla135";
    ...
    static int[] remRuin = new int[32]; static int remN = 0, rmIdle = 0, rmIdleAny = 0, rmGo = 0;
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " rm=" + rmIdle + "/" + rmIdleAny + "/" + rmGo + " ma=" + mixAsk + " mf=" + mixFlip
            ...
            if (myTile.getPaint() == PaintType.EMPTY && rc.canAttack(me)) {
                ...
                if (best != null) { rc.attack(best); state += " pnt"; }
                    ...
                    if (foe == 0) {
                        ...
                        else { MapLocation rr0 = null; int rd0 = Integer.MAX_VALUE; for (int i = remN; --i >= 0; ) { MapLocation rl = new MapLocation(remRuin[i] >> 6, remRuin[i] & 63); int dd = me.distanceSquaredTo(rl); if (dd < rd0) { rd0 = dd; rr0 = rl; } } if (rr0 != null) { explore = rr0; exploreAge = 0; rmGo++; state += " remRuin"; } else state += " frontNone"; }
                    }
