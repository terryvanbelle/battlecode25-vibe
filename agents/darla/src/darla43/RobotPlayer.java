...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla43";
     ...
     */
    static final int SPLASHER_IN_20 = 12;   // darla43: soldier share 20%->30% via the SPLASHER route. darla31 reached 30% via the mopper route and scored -1.80; same target, different lever.   // ACCEPTED iteration 1: 97-53 head-to-head vs darla_iter0 (+3.59 sd), 32 swept to 10.
