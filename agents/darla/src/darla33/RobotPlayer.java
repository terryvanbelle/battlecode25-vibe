...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla33";
    ...
    static final int MONEY_MOD = 8;   // darla33: screened at -2 on the old baseline, well INSIDE the floor that has since been shown to hide real effects. Never properly tested.
