...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla48";
            ...
            for (MapLocation c : rc.getAllLocationsWithinRadiusSquared(me, 4)) {
                ...
                for (RobotInfo f : foes) {
                    if (f.type.isTowerType() && c.distanceSquaredTo(f.location) <= 4)
                        score += (f.type.moneyPerTurn > 0) ? 20 : 12;   // darla48: the attractor threshold on the NEW build. At 15% splashers 20 cost 6 games; the scorer is unchanged but the army is not.
                }
