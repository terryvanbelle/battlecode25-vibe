...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla18";
            ...
            for (MapLocation c : rc.getAllLocationsWithinRadiusSquared(me, 4)) {
                ...
                for (RobotInfo f : foes) {
                    if (f.type.isTowerType() && c.distanceSquaredTo(f.location) <= 4)
                        score += (f.type.moneyPerTurn > 0) ? 200 : 120;   // darla18: the bonus is a POSITIONING attractor, not a weapon -- double it and see if splashers are pulled deeper.
                }
