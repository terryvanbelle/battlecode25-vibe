...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla37";
    ...
    static final int SPLASH_MIN_SCORE = 10;   // darla37: between the old 8 and the accepted 14, where the paired instrument can now resolve what the screen could not.   // ACCEPTED iteration 1, jointly with SPLASHER_IN_20 above. Neither is established alone.
