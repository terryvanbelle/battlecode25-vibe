...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla51";
            ...
            for (MapLocation c : rc.getAllLocationsWithinRadiusSquared(me, 4)) {
                ...
                for (MapInfo t : rc.senseNearbyMapInfos(c, 4)) {
                    ...
                    if (p.isEnemy()) {
                        ...
                        if (c.distanceSquaredTo(t.getMapLocation()) <= 2) score += 4;   // darla51: enemy:empty 4:2 = 2:1. Converting an ENEMY tile is worth two coverage points (one gained, one denied); an empty tile is worth one. The inherited 3:2 underprices enemy ground against the actual win condition.
