...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla17";
            ...
            for (MapLocation c : rc.getAllLocationsWithinRadiusSquared(me, 4)) {
                ...
                for (RobotInfo f : foes) {
                    if (f.type.isTowerType() && c.distanceSquaredTo(f.location) <= 4)
                        score += 0;   // darla17: NO tower bonus. No tower dies in these matchups (both sides rise monotonically to 24-25 over 1,886 rounds), so AoE spent on a 1,000-HP tower paints nothing. The firing-ring MOVEMENT is retained -- positioning is the part that can be paying.
                }
