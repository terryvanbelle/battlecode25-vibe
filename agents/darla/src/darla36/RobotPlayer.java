...
public class RobotPlayer {
    ...
    static final int CHIP_RESERVE = 600;   // darla36: NEVER TOUCHED in 34 arms, and it gates every build. Chips run $27k-46k idle, so the reserve may be protecting a resource nothing is short of.
     ...
     */
    static final String BUILD = "darla36";
