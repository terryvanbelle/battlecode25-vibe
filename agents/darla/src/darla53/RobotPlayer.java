...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla53";
    ...
    static String runSoldier() throws GameActionException {
        ...
        // darla53: soldiers no longer plink enemy towers. A soldier does 50 damage
        // [E: attackStrength] to a tower with 1,000+ HP, and NO TOWER DIES in these
        // matchups -- both teams' counts rise monotonically over a full game. So the
        // action is spent on a target that never falls, and it costs the soldier its
        // turn. Soldiers are now 20% of the army and the only unit that claims ruins,
        // so each wasted action is worth more than when this was measured at 1.3% of
        // soldier turns on a 75%-soldier build.
