...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla148";
    ...
    static boolean walkHomeIfDry(int cap) throws GameActionException {
        ...
        int low = Math.min(REFILL_LOW, cap / 4); if (!refilling && paint > low) return false;
    ...
    static String runTower() throws GameActionException {
        ...
        if (afford && want.paintCost < UnitType.SOLDIER.paintCost && !(want == UnitType.MOPPER && mopperDue && rc.getPaint() >= want.paintCost)
