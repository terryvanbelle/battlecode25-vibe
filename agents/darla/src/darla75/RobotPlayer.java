...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla75";
    ...
    static void banRuin(MapLocation r) {
        ...
        if (slot < 0) { slot = 0; for (int i = BAN_CAP; --i > 0; ) if (banUntil[i] < banUntil[slot]) slot = i; } // darla75: when the table is full, evict the SOONEST-LAPSING ban, not an arbitrary ring slot
        banKey[slot] = key;
