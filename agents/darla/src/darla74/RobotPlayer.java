...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla74";
            ...
            if (myTile.getPaint() == PaintType.EMPTY && rc.canAttack(me)) {
                ...
                if (best != null) { rc.attack(best); state += " pnt"; }
                    ...
                    if (foe == 0) {
                        ...
                        else { explore = new MapLocation(rc.getMapWidth()-1-rc.getLocation().x, rc.getMapHeight()-1-rc.getLocation().y); exploreAge = 0; state += " symTgt"; } // darla74: head for the enemy half instead of giving up
                    }
