...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla39";
    ...
    static String runTower() throws GameActionException {
        ...
        final int PAINT_FLOOR = 100;   // darla39: PAINT_FLOOR has never been touched in 38 arms, and it is what makes moppers structurally absent (1 built per game). Probing DOWNWARD first, per the gate lesson.
