...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla102";
    ...
    static String runTower() throws GameActionException {
        ...
        UnitType want = (roll < SPLASHER_IN_20) ? UnitType.SPLASHER
                      ...
                      : UnitType.SOLDIER;
        // darla102: SOLDIERS FIRST. Replay evidence against v3 (owner-granted, 2026-09-14):
        // robots built by round 40 are us 1 soldier / 4 splashers, v3 6 soldiers / 1 splasher --
        // exactly inverted. Only soldiers call workOnRuin, so v3 opens with the unit that makes
        // towers and we open with the one that cannot. First tower on shell: v3 r34, us r266.
        // The race is decided before round 100, so for those rounds build soldiers only.
