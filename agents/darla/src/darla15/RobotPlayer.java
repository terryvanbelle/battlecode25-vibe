...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla15";
    ...
    static String runSplasher() throws GameActionException {
        ...
        for (RobotInfo f : foes) {
            ...
            int rank = (f.type.moneyPerTurn > 0) ? 1 : 2;   // darla15: PAINT towers first. Per-tower paint is the binding resource for both sides, and it is what feeds the opponent's splashers -- the units that actually win the coverage race.
