...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla7";
    ...
    static final int SPLASH_MIN_SCORE = 4;   // darla7: splashers withheld fire on 34 of 142 decisions (lowScore); splashers are the coverage engine
