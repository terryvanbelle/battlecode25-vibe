...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla29";
    ...
    static String runTower() throws GameActionException {
        ...
        final int SPLASH_FLOOR = 2600;   // darla29: re-test on the ACCEPTED baseline. The mix changed from 75% soldier to 20%, and SPLASH_FLOOR gates exactly the non-splasher builds that share just collapsed.
