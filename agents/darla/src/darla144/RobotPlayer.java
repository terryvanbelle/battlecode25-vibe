...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla144";
    ...
    static int rzSeen = 0, rzTurns = 0, rzMax = 0;
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " rz=" + rzSeen + "/" + rzTurns + "/" + rzMax + " ma=" + mixAsk + " mf=" + mixFlip
    ...
    static String runSplasher() throws GameActionException {
        ...
        rzTurns++; for (MapLocation rr : rc.senseNearbyRuins(-1)) { if (rc.canSenseRobotAtLocation(rr)) continue; int ef = 0; for (MapInfo t : rc.senseNearbyMapInfos(rr, 8)) if (t.getPaint().isEnemy()) ef++; if (ef > 0) { rzSeen++; if (ef > rzMax) rzMax = ef; break; } }
