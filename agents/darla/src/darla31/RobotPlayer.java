...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla31";
    ...
    static final int MOPPER_IN_20 = 0;   // darla31: those rolls go to SOLDIERS, now 20% of the mix and the only unit that builds towers. Moppers are structurally absent anyway (1 per game).
