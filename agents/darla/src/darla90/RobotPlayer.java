...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla90";
    ...
    static String runSplasher() throws GameActionException {
        refillIfPossible();
        boolean goingHome = walkHomeIfDry(UnitType.SPLASHER.paintCapacity); // darla90: do not RETURN here. walkHomeIfDry has already spent the move, but the turn also has an ACTION, and the splasher was throwing it away: the i3 census puts P HOME at 46% of splasher turns against P SPLASH at 4%. A splasher walking home with at least one splash of paint left and a target scoring above threshold should fire it -- the trip continues either way. This is our own turn being wasted, not anything the opponent does, which is the class the v3 benchmark says to prefer.
        String tag = "";
        int bestScore = 0;
        ...
        if (goingHome) { tag += " HOME"; } else if (siege != null && rc.isMovementReady()) {
