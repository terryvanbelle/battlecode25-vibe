...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla27";
    ...
    static final int SPLASH_MIN_SCORE = 22;   // darla27: far stricter, bracketing darla26 so the axis is read as a ladder (ceiling is 35).
