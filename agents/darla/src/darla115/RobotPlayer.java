...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla115";
    ...
    static String runSplasher() throws GameActionException {
        ...
        if (ready && fueled) {
            ...
            if (best != null && bestScore >= SPLASH_MIN_SCORE) {
                ...
                int fd = 999;
                for (MapInfo t2 : rc.senseNearbyMapInfos(-1)) { if (t2.getPaint() == PaintType.EMPTY && t2.isPassable()) { int dd = me.distanceSquaredTo(t2.getMapLocation()); if (dd < fd) { fd = dd; frontier = t2.getMapLocation(); } } }
            }
        } else {
