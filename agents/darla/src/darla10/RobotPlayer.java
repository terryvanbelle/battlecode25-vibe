...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla10";
     ...
     */
    static final int SPLASHER_IN_20 = 8;   // darla10 dose: splashers are the coverage engine; abundance inverts the mix toward soldiers
