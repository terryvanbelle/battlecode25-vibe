...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla104";
    ...
    static String runTower() throws GameActionException {
        ...
        UnitType want = (roll < SPLASHER_IN_20) ? UnitType.SPLASHER
                      ...
                      : UnitType.SOLDIER;
        // darla104: soldiers until the THIRD tower. See DESIGN.md.
        if (rc.getNumberTowers() <= 2 && want != UnitType.SOLDIER) { want = UnitType.SOLDIER; mixFlip++; }
