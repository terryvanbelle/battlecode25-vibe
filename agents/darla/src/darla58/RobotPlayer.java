...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla58";
     ...
     */
    static final int SPLASHER_IN_20_SMALL = 14, SPLASHER_IN_20_LARGE = 16;   // darla57: the mix keyed on MAP AREA. Large maps are the build's weakness (56.4% vs 82.3%). Map dimensions are identical for both teams and every robot, so this stays symmetric and needs no communication.   // ACCEPTED iteration 1: 97-53 head-to-head vs darla_iter0 (+3.59 sd), 32 swept to 10.
    ...
    static String runTower() throws GameActionException {
        ...
        int SPLASHER_IN_20 = (rc.getMapWidth() * rc.getMapHeight() < 1600)
                           ? SPLASHER_IN_20_SMALL : SPLASHER_IN_20_LARGE;
