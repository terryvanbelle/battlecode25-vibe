...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla41";
    ...
    static String runSplasher() throws GameActionException {
        ...
        if (siege != null && rc.isMovementReady()) {
            ...
            // darla41: re-test darla22's centroid heading on the ACCEPTED build. It lost
            // 22 games when splashers were 15% of the army; they are now 70%, and
            // positioning is the mechanism this build is most sensitive to (removing the
            // tower attractor costs 99-51). The old verdict was measured on a bot whose
            // splashers were a minority side-show.
