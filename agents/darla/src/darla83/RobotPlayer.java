...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla83";
...
{ boolean left = (rc.getID() & 1) == 0; if (bugDir == null || !to.equals(bugTo)) bugDir = d; bugTo = to; for (int i = 0; i < 8; i++) { bugDir = left ? bugDir.rotateLeft() : bugDir.rotateRight(); if (rc.canMove(bugDir)) { rc.move(bugDir); bugDir = left ? bugDir.rotateRight() : bugDir.rotateLeft(); return true; } } return false; } // darla83 = darla82 bug-nav PLUS darla80 mv instrumentation, so the registered falsifier can actually be read
    }
}
