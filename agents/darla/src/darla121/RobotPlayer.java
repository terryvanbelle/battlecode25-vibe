...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla121";
    ...
    static int srpMark = 0, srpDone = 0;
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " srp=" + srpMark + "/" + srpDone + " ma=" + mixAsk + " mf=" + mixFlip
    ...
    static String runSoldier() throws GameActionException {
        ...
        if (rc.canCompleteResourcePattern(me0)) { rc.completeResourcePattern(me0); srpDone++; srp = null; state += " SRPdone"; }
            ...
            if (srp == null && rc.senseNearbyRuins(8).length == 0 && rc.canMarkResourcePattern(me0)) { rc.markResourcePattern(me0); srp = me0; srpMark++; state += " SRPmark"; }
            if (srp != null && me0.distanceSquaredTo(srp) > 8) srp = null;
            if (srp != null) {
                if (rc.canCompleteResourcePattern(srp)) { rc.completeResourcePattern(srp); srpDone++; srp = null; state += " SRPdone"; }
                    ...
                    if (mk == PaintType.EMPTY || mk == t.getPaint() || t.getPaint().isEnemy()) continue;
                    if (rc.canAttack(t.getMapLocation())) { rc.attack(t.getMapLocation(), mk == PaintType.ALLY_SECONDARY); state += " SRPpnt"; break; }
                }
            }
        }
