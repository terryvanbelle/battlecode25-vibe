...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla77";
    ...
    static boolean walkHomeIfDry(int cap) throws GameActionException {
        ...
        if (home == null) { refilling = false; return false; } if (rc.getLocation().distanceSquaredTo(home) <= 2) { refilling = false; return false; } // darla77: refillIfPossible already ran this turn, so a tower we are standing next to has given all it can -- queueing at a dry tower is strictly worse than acting with what we hold
        homeTurns++;
