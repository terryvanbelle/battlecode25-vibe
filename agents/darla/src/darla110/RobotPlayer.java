...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla110";
    ...
    static int lastHp = -1, dmgTurns = 0, nearSold = 0, nearAny = 0;
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " dm=" + dmgTurns + " ns=" + nearSold + "/" + nearAny + " ma=" + mixAsk + " mf=" + mixFlip
    ...
    static String runTower() throws GameActionException {
        int hpNow = rc.getHealth();
        if (lastHp >= 0 && hpNow < lastHp) { dmgTurns++; for (RobotInfo f : rc.senseNearbyRobots(GameConstants.MESSAGE_RADIUS_SQUARED, rc.getTeam())) { nearAny++; if (f.type == UnitType.SOLDIER) nearSold++; } }
        lastHp = hpNow;
