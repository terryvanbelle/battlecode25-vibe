...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla24";
    ...
    static final int MONEY_MOD = 8;   // darla24: fewer money towers. Chips pile to $27k-46k unspent while per-tower PAINT (~54) is what binds.
