...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla66";
    ...
    static final int RUIN_PATIENCE = 120;   // darla66: patience on a ruin, untested in 65 arms. Large maps are the weakness (56.4% vs 82.3%) and mean longer travel, so a soldier is more likely to hit the abandon limit before completing a pattern.   // turns before giving up on a ruin
