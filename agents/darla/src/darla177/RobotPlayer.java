...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla177";
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " sx=" + soldEx + " mp=" + moneyPick + " os=" + openSold + " ma=" + mixAsk + " mf=" + mixFlip
    ...
    static String runTower() throws GameActionException {
        ...
        if (splSince >= 3 && want != UnitType.SOLDIER && rc.getRoundNum() >= 100) { want = UnitType.SOLDIER; mixFlip++; }   // darla177: the due soldier is built now, not when rolled
