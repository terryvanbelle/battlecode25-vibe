...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla34";
    ...
    static final int SPLASH_MIN_SCORE = 20;   // darla34: refine the accepted 14 upward, now that 14 is known to be a real effect rather than the noise I called it.   // ACCEPTED iteration 1, jointly with SPLASHER_IN_20 above. Neither is established alone.
