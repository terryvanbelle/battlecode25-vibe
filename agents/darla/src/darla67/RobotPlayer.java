...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla67";
    ...
    static final int RUIN_PATIENCE = 15;   // darla67: the other side -- abandon sooner, bracketing darla66.   // turns before giving up on a ruin
