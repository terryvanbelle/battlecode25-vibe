...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla106";
    ...
    static String runSoldier() throws GameActionException {
        ...
        // darla106: defend a tower under siege. Soldiers attack only TOWERS today, so a v3
        // soldier grinding ours down at -50 a hit is unopposed. See DESIGN.md.
        if (rc.isActionReady()) { MapLocation h = nearestRememberedTower(); if (h != null && rc.getLocation().distanceSquaredTo(h) <= 16) { for (RobotInfo e : enemies) { if (!e.type.isTowerType() && rc.canAttack(e.location)) { rc.attack(e.location); state += " def"; break; } } } }
