...
public class RobotPlayer {
    ...
    static final int CHIP_RESERVE = 2400;   // darla38: the other side of darla36. CHIP_RESERVE was untouched in 34 arms; bracket it rather than probe one side.
     ...
     */
    static final String BUILD = "darla38";
