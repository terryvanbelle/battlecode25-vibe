...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla159";
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " mp=" + moneyPick + " os=" + openSold + " ma=" + mixAsk + " mf=" + mixFlip
    ...
    static String runTower() throws GameActionException {
        ...
        boolean opening = (rc.getRoundNum() < 100 && rc.getNumberTowers() <= 2);
        boolean afford = chips >= (opening ? 0 : reserve) + want.moneyCost;
