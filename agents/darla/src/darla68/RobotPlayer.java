...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla68";
    ...
    static final int RUIN_BAN_ROUNDS = 60;   // darla68: never varied in 67 arms. A banned ruin is off-limits for 250 rounds -- a quarter of a game -- and abandoning sooner hurt (-2.45 sd), so how long the ban LASTS is the same lever from the other end.
