...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla101";
    ...
    static String runTower() throws GameActionException {
        ...
        // darla101: keep the ROLL, relax only the FLOOR. See DESIGN.md.
        ...
        if (afford && !moppableWork && want.paintCost < UnitType.SOLDIER.paintCost
