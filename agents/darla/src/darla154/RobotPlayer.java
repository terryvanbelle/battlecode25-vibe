...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla154";
    ...
    static boolean soldierDue = false; static int soldEx = 0;
    ...
    static void monitorAndYield(int startRound, String state) {
        ...
        rc.setIndicatorString("[" + BUILD + "] bc=" + used + "/" + limit + " max=" + bcMaxUsed
            ...
            + " sx=" + soldEx + " ma=" + mixAsk + " mf=" + mixFlip
    ...
    static String runTower() throws GameActionException {
        ...
        boolean exS = (want == UnitType.SOLDIER && soldierDue);
        if (afford && !exS && want != UnitType.SPLASHER && chips - want.moneyCost < SPLASH_FLOOR) {
            afford = false;
        }
        ...
        if (afford) {
            ...
            if (rc.canBuildRobot(want, loc)) { rc.buildRobot(want, loc); if (want == UnitType.SPLASHER) soldierDue = true; else if (want == UnitType.SOLDIER && exS) { soldierDue = false; soldEx++; } }
        }
