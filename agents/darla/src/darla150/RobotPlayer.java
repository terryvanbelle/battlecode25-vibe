...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla150";
    ...
    static UnitType towerTypeFor(MapLocation ruin) {
        ...
        if (seenPaint + seenMoney >= CENSUS_MIN && seenMoney * 2 < seenPaint) { mixFlip++; moneyPick++; return UnitType.LEVEL_ONE_MONEY_TOWER; }
