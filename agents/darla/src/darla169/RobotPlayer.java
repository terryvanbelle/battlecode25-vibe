...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla169";
    ...
    static final int SPLASH_MIN_SCORE = 18;   // ACCEPTED iteration 1, jointly with SPLASHER_IN_20 above. Neither is established alone.
