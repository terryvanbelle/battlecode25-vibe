...
public class RobotPlayer {
     ...
     */
    static final String BUILD = "darla55";
    ...
    static UnitType towerTypeFor(MapLocation ruin) {
        ...
        if (k % 7 == 3) return UnitType.LEVEL_ONE_DEFENSE_TOWER;   // darla55: DEFENSE towers, the last engine mechanic no lineage has ever built. ~1 ruin in 7, on the same symmetry-invariant lattice so both teams and every soldier still agree.
