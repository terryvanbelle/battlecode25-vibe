...
# line hours later.
EVAL_JOB_RE='widen2\.sh|widen\.sh|head-to-head\.sh|roster-screen\.sh|replicate\.sh|paired-roster\.sh|darla-largemap\.sh|darla-band\.sh|darla-vs\.sh|darla-fresh\.sh'
