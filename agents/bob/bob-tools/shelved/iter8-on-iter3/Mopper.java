...
public class Mopper {
    static void run() throws GameActionException {
        ...
        // Iteration 8. Moppers had NO refill path at all and died starved 85 times
        // in 108 deaths. A mopper pays MOPPER_PAINT_PENALTY_MULTIPLIER=2 on the
        // territory penalty, so it burns 4/turn on enemy paint out of a 100 cap --
        // 25 turns from full to dead. Mopping itself costs 0 paint, so a mopper that
        // stays alive is free denial forever; this is pure capability preservation.
        if (Refill.seek(35)) return;
