...
public class RobotPlayer {
    ...
    static void runTower(RobotController rc) throws GameActionException {
        ...
        if (rc.getMoney() >= CHIP_RESERVE) {
            ...
            // ARM B -- REPLACE the chip proxy with the phase signal. The money term is
            // the reserve plus the splasher's own price, so the reserve discipline of
            // iterations 25/26 is preserved and no searched constant survives.
