...
public class RobotPlayer {
    ...
    public static void run(RobotController rc) throws GameActionException {
        rngState = rc.getID() * 31 + 18;   // PHASE NULL: policy-identical to alice_iter30,
                                           // only the PRNG seed offset differs (17 -> 18).
                                           // Every decision keeps the same DISTRIBUTION; only
                                           // the realisation changes. Any net swept this
                                           // measures against alice_iter30 is pure engine
                                           // chaos and is my resolution floor.
