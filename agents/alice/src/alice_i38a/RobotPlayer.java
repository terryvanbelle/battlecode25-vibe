...
public class RobotPlayer {
    ...
    static void runTower(RobotController rc) throws GameActionException {
        ...
        if (rc.getMoney() >= CHIP_RESERVE) {
            // ITERATION 38 (arm a): make the mopper rate EXPLICIT, deleting a hidden parameter.
            //
            ...
            //
            // The fix is a per-tower counter, so the rate is exactly 1 in 4 by construction
            ...
            UnitType want = (spawnSeq++ % 4 == 0) ? UnitType.MOPPER : UnitType.SOLDIER;
