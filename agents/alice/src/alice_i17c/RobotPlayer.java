...
public class RobotPlayer {
    ...
    static void runSoldier(RobotController rc) throws GameActionException {
        ...
        if (ruin != null) {
            ...
            // DIAGNOSTIC (i17c): always mark a MONEY tower. If tower count roughly
            // DOUBLES versus parity, then the paint-marked half of all ruins is
            // being thrown away -- marked but never completed -- and this lineage
            // has been wasting half its ruins since iteration 0.
            UnitType wantTower = UnitType.LEVEL_ONE_MONEY_TOWER;
