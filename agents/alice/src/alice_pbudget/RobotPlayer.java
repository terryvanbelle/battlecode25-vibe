...
public class RobotPlayer {
    ...
    static int pbMark = 0, pbPat = 0, pbSelf = 0, pbArea = 0, pbBorn = -1;          // worst bytecode usage seen
        ...
        while (true) {
            ...
            try {
                ...
                if (rc.getType() == UnitType.SOLDIER) {
                    ...
                    rc.setIndicatorString("PB mark=" + pbMark + " pat=" + pbPat
