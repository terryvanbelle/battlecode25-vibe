...
public class RobotPlayer {
    ...
    /** SYNTHETIC ARCHETYPE -- the spender pole. alice_flood is alice_iter14 with the
     *  chip reserve removed: towers spawn whenever a spawn is affordable and never
     *  hold chips back. It exists because my entire peer pool is my own lineage and
     *  every member of it carries the same 1450-chip stall, so no instrument I own
     *  can see what that stall costs (TRAINING_ALGORITHM, "the self-referential
     *  blind spot", and Measurement doctrine #4 on representativeness). The
     *  tournament replay alice-vs-bob on Paintball shows the opposing lineage at
     *  $0 with 8 soldiers on round 50 while alice sits at $1150 with 4 and its army
     *  collapses to 1 by round 75. This archetype poses that behaviour.
     *  FROZEN: never retune it. Its value is that it does not change. */
