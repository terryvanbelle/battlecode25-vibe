...
public class RobotPlayer {
    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        while (true) {
            ...
            try {
                ...
                rc.setIndicatorString("T try=" + t_try + " wan=" + t_wan + " sl=" + t_slide + " | " + "i25=" + i25Refills + "/" + i25Paint + " "
    ...
    // --- iteration 59: WHERE DOES MOVEMENT ACTUALLY HAPPEN? ---
    // Iteration 58 installed a crowd tie-break in tryMove only, having measured the
    // choice set over ALL movement turns. It did not fire. This counts the split at
    // the two call sites, i.e. the denominator the mechanism actually saw.
    // Registered readings, fixed before the number: >=40% the site is fine and the
    // dose is too weak; 10-39% re-site into wander's slide; <10% the site was the
    // whole problem and iteration 58 never tested crowd-avoidance at all.
    static long t_try = 0, t_wan = 0, t_slide = 0;
    ...
    static void wander(RobotController rc) throws GameActionException {
        if (!rc.isMovementReady()) return;
        t_wan++;   // PROBE: a movement-ready turn that goes through wander
        ...
        if (rc.canMove(wanderDir)) {
            ...
            // per-side tempo edge.
            t_slide++;   // PROBE: wander was BLOCKED, i.e. the slide branch
    ...
    static void tryMove(RobotController rc, Direction dir) throws GameActionException {
        ...
        t_try++;   // PROBE: a movement-ready turn that goes through tryMove
