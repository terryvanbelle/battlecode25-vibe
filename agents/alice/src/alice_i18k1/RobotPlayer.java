...
public class RobotPlayer {
    ...
    static void runSoldier(RobotController rc) throws GameActionException {
        ...
        if (ruin != null) {
            ...
            // Iteration 18 dose K=1: money only when BOTH parity bits are even
            // (corpus money-share 0.26). Same parity backbone as alice_iter14 with
            // one extra bit, so K=2 of this ladder IS alice_iter14 byte for byte.
            int p18 = (ruin.x + ruin.y) & 1, q18 = ((ruin.x >> 1) + (ruin.y >> 1)) & 1;
            UnitType wantTower = (p18 == 0 && q18 == 0)
