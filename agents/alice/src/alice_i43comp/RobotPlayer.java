    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        while (true) {
            ...
            try {
                ...
                rc.setIndicatorString((rc.getType().isTowerType() ? ("TT="
                        + (rc.getType().name().contains("MONEY") ? "M"
                           : rc.getType().name().contains("PAINT") ? "P" : "D")
                        + " tm=" + rc.getMoney() + " tp=" + rc.getPaint() + " ") : "")
